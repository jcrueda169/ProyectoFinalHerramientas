...
=======
En esta sección nos interesa explorar cada indice (IDH), para esto se realizan varias estadisticas. En primer lugar, se evalua el numero de datos y la mediana de cada uno de los tipos de población.
