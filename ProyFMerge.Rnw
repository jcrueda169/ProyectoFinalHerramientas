...
\[EN= \frac{Prom de años de educación niños} {15}  \]

La variable del nivel de vida mide el PIB per cápita de una zona o país teniendo en cuenta un mínimo esperado y un maximo. La formula es la siguiente
...
Comencemos viendo que hay en la sección \ref{univariada} en la página \pageref{univariada}.
